...
# print(math.sqrt((1-0.856)**2 + (1-0.773)**2))
# print(math.sqrt((1-0.581)**2 + (1-0.769)**2))
# print(math.sqrt((1-0.783)**2 + (1-0.712)**2))
# print(math.sqrt((1-0.456)**2 + (1-0.926)**2))

class NIQE_metric(object):
    def __init__(self) -> None:
        device = torch.device("cuda")
        self.niqe_metric = pyiqa.create_metric('liqe', device=device)
