...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', required=False, default='/root/data/vjuicefs_ai_camera_jgroup_livephoto/11182563/color_transfer/data_crop', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/data/vjuicefs_ai_camera_jgroup_livephoto/11182563/color_transfer/method/weight', help='models are saved here')
